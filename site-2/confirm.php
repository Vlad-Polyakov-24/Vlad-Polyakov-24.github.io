...
<div class="wrapper" id="wrapper">
    ...
    <main class="app" id="app">
      <section class="confirmation section-padding">
        <div class="container">
          <div class="section-title">
            <h2 class="section-title__title">内容確認</h2>
          </div>
          <form class="form form--confirm" id="form_confirm" method="post">
            <div class="form__group">
              <label class="form__label">氏名</label>
              <p class="form__confirm-text"></p>
              <label class="form__hidden-label">
                <input type="hidden" name="user_name">
              </label>
            </div>
            <div class="form__group">
              <label class="form__label">会社名</label>
              <p class="form__confirm-text"></p>
              <label class="form__hidden-label">
            ...
            <div class="form__group">
              <label class="form__label">部署名</label>
              <p class="form__confirm-text"></p>
              <label class="form__hidden-label">
            ...
            <div class="form__group">
              <label class="form__label">ご質問・不明点等</label>
              <p class="form__confirm-text"></p>
              <label class="form__hidden-label">
                <input type="hidden" name="user_question">
              </label>
            </div>
            <div class="form__button-wrap">
              <button type="button" class="btn" onclick="window.history.back();">内容を修正する</button>
