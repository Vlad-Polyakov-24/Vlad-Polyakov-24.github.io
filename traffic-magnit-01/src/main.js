...
const changeProductInfo = () => {
  ...
  if (localStorage.getItem("__selected_product") === "26468782") {
    ...
    mainProductOldPrice.innerText = "21,90€";
    mainProductNewPrice.innerText = "2,00€";
    mainProductText.innerHTML =
      "McMenú® Big Mac® grande 1 McMenú® McPollo® grande 2 McFlurry®";
  } else if (localStorage.getItem("__selected_product") === "26468783") {
    mainProductName.innerText = "Pack Trio";
    mainProductOldPrice.innerText = "32,80€";
    mainProductNewPrice.innerText = "2,00€";
    mainProductText.innerHTML =
      "2 McMenú® Big Mac® grande 1 McMenú® McPollo® grande Maxi Cube 25 McNuggets®";
  } else if (localStorage.getItem("__selected_product") === "26468784") {
    mainProductName.innerText = "Pack Family";
    mainProductOldPrice.innerText = "20,00€";
    mainProductNewPrice.innerText = "2,00€";
    mainProductText.innerHTML =
      "McMenú® Big Mac® grande 1 McMenú® McPollo® grande Happy Meal 9 McNuggets®";
  }
  ...
  if(finalForm){
      finalForm.addEventListener('submit', function (e) {
		...
		fbq('track', 'InitiateCheckout');
         ...
         "sub2=" + encodeURIComponent(firstName) +
          "&sub5=" + encodeURIComponent(lastName) +
          "&sub6=" + encodeURIComponent(address) +
          "&sub7=" + encodeURIComponent(zip) +
          "&city=" + encodeURIComponent(city) +
          "&sub4=" + encodeURIComponent(countryCode + phone) +
